...
describe('Controller Tests', function() {
    ...
    describe('Employee Management Detail Controller', function() {
        var $scope, $rootScope;
        var MockEntity, MockPreviousState, MockEmployee, MockVacationStock, MockVacationRequest, MockJob, MockDepartment;
        ...
        describe('Root Scope Listening', function() {
            it('Unregisters root scope listener upon scope destruction', function() {
                var eventType = 'myHrAppConcediuApp:employeeUpdate';
